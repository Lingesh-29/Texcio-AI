...
{{-- Start View Blog --}}
<section class="relative py-5 lg:py-12 overflow-hidden">
    <img class="absolute top-0 left-0 mt-10"
        src="{{ asset('themes/modern-orange/assets/images/content/stars-left-top.svg') }}" alt="">
    <img class="absolute bottom-0 right-0"
        src="{{ asset('themes/modern-orange/assets/images/content/orange-light-right.png') }}" alt="">
    <div class="relative container px-4 mx-auto">
        <div class="text-center mb-18">
            <span
                class="inline-block py-1 px-3 mb-4 text-xs font-semibold text-orange-900 bg-orange-50 rounded-full">{{ $blogDetails->blogCategory->blog_category_title }}</span>
            <h1 class="font-heading text-3xl xs:text-4xl md:text-5xl font-bold text-gray-900 mb-12">
                <span>{{ $blogDetails->heading }}</span>
            </h1>
            <div>
                <img class="block w-full lg:w-1/2 lg:h-1/2 lg:object-center mx-auto"
                        ...
                        <div class="flex flex-wrap -m-2">
                            <div class="w-auto p-2">
                                ...
                                <a href="{{ route('sharetofacebook', $blogDetails->slug) }}" target="_blank"
                                    class="flex items-center justify-center p-3 text-white hover:text-black font-medium tracking-tighter bg-orange-900 hover:bg-orange-700 border-2 border-white focus:border-green-400 focus:border-opacity-40 focus:ring-4 focus:ring-green-400 focus:ring-opacity-40 rounded-full transition duration-300">
                            ...
                            <div class="flex flex-wrap -mx-4 -mb-12">
                                @foreach ($recentBlogs as $blog)
                                    <div class="w-full md:w-1/2 xl:w-1/3 px-4 mb-12 border-r border-gray-100">
                                        <a class="block group" href="{{ route('web.view.blog', $blog->slug) }}">
                                            ...
                                            <h4
                                                class="text-xl font-semibold text-gray-900 group-hover:text-orange-900 mb-4">
                                                {{ $blog->heading }}</h4>
