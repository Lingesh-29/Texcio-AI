                            ...
                            <form action="{{ route('user.update.ai.code') }}" id="saveForm" method="POST">
                                ...
                                <div class="card-body custom-body">
                                    ...
                                    <textarea class="form-control" name="result"
                                        id="result">{{ $content->content }}</textarea>
                                </div>
...
<script>
    tinymce.init({
      ...
      plugins: 'preview importcss searchreplace autolink autosave save directionality visualblocks visualchars link table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons code',
      menubar: 'file edit view insert format tools table help',
      toolbar: 'undo redo | code | bold italic underline strikethrough | fontfamily fontsize blocks | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist | forecolor backcolor removeformat | pagebreak | charmap emoticons | preview save print | insertfile link anchor | ltr rtl',
      toolbar_sticky: true,
