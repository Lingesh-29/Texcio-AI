                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-select" name="results" id="results" required>
                                            ...
                                            @if ($config[46]->config_value == "dall-e-2")
                                                ...
                                                @endfor
                                            @else
                                                <option value="1" {{ 1 == 1 ? 'selected' : ''}}>{{ __('1') }}</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
