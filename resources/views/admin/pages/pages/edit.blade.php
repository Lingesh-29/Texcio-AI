                                ...
                                <div class="col-xl-12">
                                    ...
                                    @for ($i = 0; $i < 2; $i++) <div id="section{{ $i }}" class="row">
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                <textarea rows="6" cols="10" class="form-control body" name="section{{ $i }}" placeholder="{{ $sections[$i]->title }}">{!! $sections[$i]->body !!}</textarea>
                                            </div>
                                        </div>
                                </div>
                                @endfor
...
<script>
    tinymce.init({
      ...
      plugins: 'code importcss searchreplace autolink autosave save directionality visualblocks visualchars link charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount charmap quickbars emoticons image',
      ...
      setup: function (editor) {
        editor.on('init', function () {
          ...
          htmlElement.setAttribute("class", "mce-content-body antialiased bg-body text-body font-body zoom");
        });
      },
      toolbar: 'code undo redo | bold italic underline strikethrough | fontfamily fontsize blocks | alignleft aligncenter alignright alignjustify | image outdent indent | numlist bullist | forecolor backcolor removeformat | pagebreak | charmap emoticons | preview save print | insertfile link anchor | ltr rtl',
