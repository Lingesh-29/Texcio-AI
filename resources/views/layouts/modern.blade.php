...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="{{ asset('themes/modern/css/tailwind/tailwind.min.css') }}">
    <link rel="stylesheet" href="{{ asset('themes/modern/css/main.css') }}">
    <link rel="stylesheet" href="{{ asset('css/aos.css') }}">

    <!-- Scripts -->
    <script type="text/javascript" src="{{ asset('js/jquery.min.js') }}"></script>
    <script src="{{ asset('themes/modern/js/main.js') }}"></script>
